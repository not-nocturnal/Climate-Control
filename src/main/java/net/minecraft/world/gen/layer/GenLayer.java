...
public abstract class GenLayer {
    ...
    protected static boolean compareBiomesById(final int p_151616_0_, final int p_151616_1_) {
        if (p_151616_0_ == p_151616_1_) {
            ...
            if (p_151616_0_ != BiomeGenBase.mesaPlateau_F.biomeID && p_151616_0_ != BiomeGenBase.mesaPlateau.biomeID) {
                try {
                    return BiomeGenBase.getBiome(p_151616_0_) != null && BiomeGenBase.getBiome(p_151616_1_) != null
                        ? BiomeGenBase.getBiome(p_151616_0_)
                            .isEqualTo(BiomeGenBase.getBiome(p_151616_1_))
                        : false;
                ...
                return p_151616_1_ == BiomeGenBase.mesaPlateau_F.biomeID
                    || p_151616_1_ == BiomeGenBase.mesaPlateau.biomeID;
            }
    }
                                    ...
                                    : (p_151617_2_ == p_151617_3_ && p_151617_1_ != p_151617_4_ ? p_151617_2_
                                        : (p_151617_2_ == p_151617_4_ && p_151617_1_ != p_151617_3_ ? p_151617_2_
                                            : (p_151617_3_ == p_151617_4_ && p_151617_1_ != p_151617_2_ ? p_151617_3_
                                                : this.selectRandom(
                                                    new int[] { p_151617_1_, p_151617_2_, p_151617_3_,
                                                        p_151617_4_ }))))))))));
    }
