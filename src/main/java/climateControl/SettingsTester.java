            ...
            if (minecraft != null) {
                ...
                for (int i = 1; i < 4; i++) {
                    try {
                        ...
                        Logger.getLogger(SettingsTester.class.getName())
        ...
        if (tested.randomBiomes.value() == false) {
            ...
            if (highestActive == -1) {
                throw new RuntimeException(
                    "Climate Control: All Climate incidences set to 0. At least one much be positive");
            }
            ...
            BiomeRandomizer.PickByClimate testClimatePicker = new BiomeRandomizer(tested.biomeSettings())
                .pickByClimate();
