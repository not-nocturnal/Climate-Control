...
abstract public class AbstractWorldGenerator {
    ...
    public int rtgAwareRiverReduction(int baseReduction, WorldType worldType) {
        if (worldType.getWorldTypeName()
            .equalsIgnoreCase("RTG")) return 100;
        return baseReduction;
    }

    public GenLayerRiverMix vanillaExpansion(long worldSeed, WorldType par2WorldType, GenLayer genlayer3,
    ...
    public GenLayerRiverMix oneSevenExpansion(long worldSeed, WorldType par2WorldType, GenLayer genlayer3,
        ClimateControlSettings settings) {
        byte b0 = settings().biomeSize.value()
            .byteValue();
        ...
        GenLayer genlayerhills = new GenLayerSubBiome(
            1000L,
            object,
            genlayer1,
            subBiomeChooser,
    ...
    public GenLayerRiverMix oneSixExpansion(long worldSeed, WorldType par2WorldType, GenLayer genlayeraddmushroomisland,
        ClimateControlSettings settings) {
