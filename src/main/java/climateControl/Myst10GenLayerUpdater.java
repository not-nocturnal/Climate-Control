...
public class Myst10GenLayerUpdater {
    ...
    private class BiomeController implements IBiomeController {
        ...
        public BiomeGenBase[] getBiomesFromGenerationField(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3,
            int par4, int par5) {
            return this.manager.getBiomesForGeneration(par1ArrayOfBiomeGenBase, par2, par3, par4, par5);
        }

        public BiomeGenBase[] getBiomesAtCoords(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4,
        ...
        public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3,
            int par4, int par5) {
            return this.manager.getBiomesForGeneration(par1ArrayOfBiomeGenBase, par2, par3, par4, par5);
        }
    }
