...
public class GenLayerAdjustIsland extends GenLayerNeighborTesting {
    ...
    public GenLayerAdjustIsland(long par1, GenLayer par3GenLayer, int maxLandAdvance, int minSeaAdvance,
        int changeChances, boolean separate) {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4) {
        ...
        for (int i2 = 0; i2 < par4; i2++) {
            for (int j2 = 0; j2 < par3; j2++) {
                ...
                if (isOceanic(k3)
                    && ((!isOceanic(up)) || (!isOceanic(left)) || (!isOceanic(right)) || (!isOceanic(down)))) {
                    int i4 = k3;
                    int hits = 0;
                    ...
                    if (!isOceanic(left)) {
                        ...
                        if (this.nextInt(changeChances) < maxLandAdvance
                            ...
                            // if ( (j2==8&&i2==9)) throw new RuntimeException(""+acceptableNeighbors(left, aint, i2,
                            // j2, k1)+
                            // " " + separate +" "+message);
                            if (hits == 0) {
                                i4 = left;
