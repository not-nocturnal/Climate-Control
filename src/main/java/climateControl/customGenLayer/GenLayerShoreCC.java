...
public class GenLayerShoreCC extends GenLayerPack {
    ...
    public int[] getInts(int par1, int par2, int par3, int par4) {
        ...
        for (int i1 = 0; i1 < par4; ++i1) {
            for (int j1 = 0; j1 < par3; ++j1) {
                ...
                } else if (k1 != BiomeGenBase.extremeHills.biomeID && k1 != BiomeGenBase.extremeHillsEdge.biomeID
                    && k1 != BiomeGenBase.extremeHillsPlus.biomeID) {
    ...
    private void func_151632_a(int[] parentVals, int[] resultVals, int p_151632_3_, int p_151632_4_, int p_151632_5_,
        int originalBiome, int replacementBeach) {
