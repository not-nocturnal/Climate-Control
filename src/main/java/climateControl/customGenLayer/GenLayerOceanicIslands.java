...
public class GenLayerOceanicIslands extends GenLayerPack {
    ...
    public GenLayerOceanicIslands(long p_i45480_1_, GenLayer p_i45480_3_, int milleFill, final RandomIntUser island,
        boolean suppressDiagonals, String layerName) {
        super(p_i45480_1_);
        this.parent = p_i45480_3_;
        this.milleFill = milleFill;
    ...
    public GenLayerOceanicIslands(long p_i45480_1_, GenLayer p_i45480_3_, int milleFill, IslandClimateMaker island,
        boolean suppressDiagonals, String layerName) {
        super(p_i45480_1_);
        this.parent = p_i45480_3_;
        this.milleFill = milleFill;
            ...
            for (int j2 = 0; j2 < par3; ++j2) {
                ...
                if (isOceanic(k3) && isOceanic(k2) && isOceanic(l2) && isOceanic(i3) && isOceanic(j3)) {
                    if (suppressDiagonals) {
                        ...
                        if (!isOceanic(upperLeft) || !isOceanic(upperRight)
                            || !isOceanic(lowerLeft)
                            || !isOceanic(lowerRight)) {
                            continue;
                        }
                    }
        ...
        for (int i2 = 1; i2 < par4 + 3; ++i2) {
            for (int j2 = 1; j2 < par3 + 3; ++j2) {
                ...
                if (isOceanic(k3) && isOceanic(k2) && isOceanic(l2) && isOceanic(i3) && isOceanic(j3)) {
                    ...
                    if (this.nextInt(1000) < milleFill) {
                        LocatedInt toAdd = new LocatedInt(
                            new PlaneLocation(j2, i2),
