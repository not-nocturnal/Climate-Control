            ...
            for (int j2 = 0; j2 < par3; j2++) {
                ...
                if (isOceanic(k3) && (!isOceanic(k2) || !isOceanic(l2) || !isOceanic(i3) || !isOceanic(j3))) {
                    ...
                    if (!isOceanic(k2) && this.nextInt(l3++) == 0) {
                        if ((!separate) || this.acceptableNeighbors(k2, aint, i2, j2, k1)) i4 = k2;
                    }

                    if (!isOceanic(l2) && this.nextInt(l3++) == 0) {
                        if ((!separate) || this.acceptableNeighbors(l2, aint, i2, j2, k1)) i4 = l2;
                    }

                    if (!isOceanic(i3) && this.nextInt(l3++) == 0) {
                        if ((!separate) || this.acceptableNeighbors(i3, aint, i2, j2, k1)) i4 = i3;
                    }

                    if (!isOceanic(j3) && this.nextInt(l3++) == 0) {
                        if ((!separate) || this.acceptableNeighbors(j3, aint, i2, j2, k1)) i4 = j3;
                    }
                ...
                if (aint1[j2 + i2 * par3] < 0) throw new RuntimeException(
                    "i2 " + i2
                        + " j2 "
                        + j2
                        + " k2 "
