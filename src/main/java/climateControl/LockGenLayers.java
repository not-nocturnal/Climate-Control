    ...
    private Filter<GenLayer> isBiomeLayer() {
        return new Filter<GenLayer>() {
            ...
            public boolean accepts(GenLayer tested) {
                ...
                if (tested.getClass()
                    .getCanonicalName()
                    .contains("BiomeLayerBiomes")) return true;
                if (tested.getClass()
                    .getCanonicalName()
                    .contains("GenLayerBiomeEdgeHL")) return true;
                if (tested.getClass()
                    .getCanonicalName()
                    .contains("GenLayerBiomeByTaggedClimate")) return true;
                return false;
            }
    ...
    private Filter<GenLayer> isSubBiomeLayer() {
        return new Filter<GenLayer>() {
            ...
            public boolean accepts(GenLayer tested) {
                ...
                if (tested.getClass()
                    .getCanonicalName()
                    .contains("GenLayerRareBiome")) return true;
                if (tested.getClass()
                    .getCanonicalName()
                    .contains("BiomeLayerSub")) return true;
    ...
    private Filter<GenLayer> mushroomIslandParent() {
        ...
        return new Filter<GenLayer>() {
            ...
            public boolean accepts(GenLayer tested) {
                ...
                if (tested.getClass()
                    .getName()
                    .contains("GenLayerAddMushroomIsland")) {
