...
public class BoPSettings extends BiomeSettings {
    ...
    public void setRules(ClimateControlRules rules) {
        rules.noBeaches(
            this.coralReef.biomeID()
                .value());
        rules.noBeaches(
            this.kelpForest.biomeID()
                .value());
        setVillages(rules);
        // nothing yet
    }
