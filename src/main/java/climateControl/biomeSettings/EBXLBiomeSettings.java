...
public class EBXLBiomeSettings extends BiomeSettings {
    ...
    public void setNativeBiomeIDs(File configDirectory) {
        ...
        this.alpine.biomeID()
            .set(EBXLBiomes.alpine.biomeID());
        this.autumnwoods.biomeID()
            .set(EBXLBiomes.autumnwoods.nativeBiomeID());
        this.birchforest.biomeID()
            .set(EBXLBiomes.birchforest.nativeBiomeID());
        this.extremejungle.biomeID()
            .set(EBXLBiomes.extremejungle.nativeBiomeID());
        this.forestedhills.biomeID()
            .set(EBXLBiomes.forestedhills.nativeBiomeID());
        this.forestedisland.biomeID()
            .set(EBXLBiomes.forestedisland.nativeBiomeID());
        this.glacier.biomeID()
            .set(EBXLBiomes.glacier.nativeBiomeID());
        this.greenhills.biomeID()
            .set(EBXLBiomes.greenhills.nativeBiomeID());
        this.greenswamp.biomeID()
            .set(EBXLBiomes.greenswamp.nativeBiomeID());
        this.icewasteland.biomeID()
            .set(EBXLBiomes.icewasteland.nativeBiomeID());
        this.marsh.biomeID()
            .set(EBXLBiomes.marsh.nativeBiomeID());
        this.meadow.biomeID()
            .set(EBXLBiomes.meadow.nativeBiomeID());
        this.minijungle.biomeID()
            .set(EBXLBiomes.minijungle.nativeBiomeID());
        this.mountaindesert.biomeID()
            .set(EBXLBiomes.mountaindesert.nativeBiomeID());
        this.mountainridge.biomeID()
            .set(EBXLBiomes.mountainridge.nativeBiomeID());
        this.mountaintaiga.biomeID()
            .set(EBXLBiomes.mountaintaiga.nativeBiomeID());
        this.pineforest.biomeID()
            .set(EBXLBiomes.pineforest.nativeBiomeID());
        this.rainforest.biomeID()
            .set(EBXLBiomes.rainforest.nativeBiomeID());
        this.redwoodforest.biomeID()
            .set(EBXLBiomes.redwoodforest.nativeBiomeID());
        this.redwoodlush.biomeID()
            .set(EBXLBiomes.redwoodlush.nativeBiomeID());
        this.savanna.biomeID()
            .set(EBXLBiomes.savanna.nativeBiomeID());
        this.shrubland.biomeID()
            .set(EBXLBiomes.shrubland.nativeBiomeID());
        this.snowyforest.biomeID()
            .set(EBXLBiomes.snowforest.nativeBiomeID());
        this.snowyrainforest.biomeID()
            .set(EBXLBiomes.snowyrainforest.nativeBiomeID());
        this.temperaterainforest.biomeID()
            .set(EBXLBiomes.temperaterainforest.nativeBiomeID());
        this.tundra.biomeID()
            .set(EBXLBiomes.tundra.nativeBiomeID());
        this.wasteland.biomeID()
            .set(EBXLBiomes.wasteland.nativeBiomeID());
        this.woodlands.biomeID()
            .set(EBXLBiomes.woodland.nativeBiomeID());
    }
