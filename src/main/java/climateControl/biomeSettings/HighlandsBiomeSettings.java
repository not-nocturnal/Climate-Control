...
public class HighlandsBiomeSettings extends BiomeSettings {
    ...
    public void setNativeBiomeIDs(File configDirectory) {
        try {
            this.alps.biomeID()
                .set(Config.alpsID);
            this.autumnForest.biomeID()
                .set(Config.autumnForestID);
            this.badlands.biomeID()
                .set(Config.badlandsID);
            this.baldHill.biomeID()
                .set(Config.baldHillID);
            this.birchHills.biomeID()
                .set(Config.birchHillsID);
            this.bog.biomeID()
                .set(Config.bogID);
            this.canyon.biomeID()
                .set(Config.canyonID);
            this.cliffs.biomeID()
                .set(Config.cliffsID);
            this.desertIsland.biomeID()
                .set(Config.desertIslandID);
            this.desertMountains.biomeID()
                .set(Config.desertMountainsID);
            this.dunes.biomeID()
                .set(Config.dunesID);
            this.estuary.biomeID()
                .set(Config.estuaryID);
            this.flyingMountains.biomeID()
                .set(Config.flyingMountainsID);
            this.forestIsland.biomeID()
                .set(Config.forestIslandID);
            this.glacier.biomeID()
                .set(Config.glacierID);
            this.highlandsb.biomeID()
                .set(Config.highlandsbID);
            this.lowlands.biomeID()
                .set(Config.lowlandsID);
            this.jungleIsland.biomeID()
                .set(Config.jungleIslandID);
            this.lake.biomeID()
                .set(Config.lakeID);
            this.meadow.biomeID()
                .set(Config.meadowID);
            ...
            this.ocean2.biomeID()
                .set(Config.ocean2ID);
            this.outback.biomeID()
                .set(Config.outbackID);
            this.pinelands.biomeID()
                .set(Config.pinelandsID);
            this.rainforest.biomeID()
                .set(Config.rainforestID);
            this.redwoodForest.biomeID()
                .set(Config.redwoodForestID);
            this.rockIsland.biomeID()
                .set(Config.rockIslandID);
            this.rockMountains.biomeID()
                .set(Config.rockMountainsID);
            this.sahel.biomeID()
                .set(Config.sahelID);
            this.savannah.biomeID()
                .set(Config.savannahID);
            this.shrublands.biomeID()
                .set(Config.shrublandID);
            this.snowIsland.biomeID()
                .set(Config.snowIslandID);
            this.snowMountains.biomeID()
                .set(Config.snowMountainsID);
            this.tallPineForest.biomeID()
                .set(Config.tallPineForestID);
            this.tropicalIslands.biomeID()
                .set(Config.tropicalIslandsID);
            this.tropics.biomeID()
                .set(Config.tropicsID);
            this.tundra.biomeID()
                .set(Config.tundraID);
            this.valley.biomeID()
                .set(Config.valleyID);
            this.volcanoIsland.biomeID()
                .set(Config.volcanoIslandID);
            this.windyIsland.biomeID()
                .set(Config.windyIslandID);
            this.woodlandMountains.biomeID()
                .set(Config.woodlandMountainsID);
            this.woodlands.biomeID()
                .set(Config.woodlandsID);
