...
public class EBBiomeSettings extends BiomeSettings {
    ...
    public final Element MountainousArchipelago = new Element(
        "Mountainous Archipelago",
        62,
        1,
        Climate.DEEP_OCEAN.name);
    ...
    public final Mutable<Boolean> biomesInNewWorlds = climateControlCategory
        .booleanSetting(this.startBiomesName(configName), "Use biomes in new worlds and dimensions", true);
    ...
    private class NativeSettings extends Settings {
        ...
        void setIDs(Configuration settingFrom) {
            ...
            for (LinkedSetting linkage : linkedSettings) {
                linkage.settingInCC.biomeID()
                    .set(linkage.settingInEB);
            }
        }
        ...
        private class LinkedSetting {
            ...
            LinkedSetting(Element element) {
                settingInCC = element;
                settingInEB = biomeIDCategory.intSetting(
                    "Biome ID of " + element.name,
                    element.biomeID()
                        .value());
            }
        }
