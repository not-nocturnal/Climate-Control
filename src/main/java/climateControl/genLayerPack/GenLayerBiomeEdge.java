...
public class GenLayerBiomeEdge extends GenLayerPack {
            ...
            for (int j1 = 0; j1 < par3; ++j1) {
                ...
                if (!this.func_151636_a(
                    ...
                    && !this.func_151635_b(
                        ...
                        par3,
                        k1,
                        BiomeGenBase.mesaPlateau.biomeID,
                        BiomeGenBase.mesa.biomeID)
                    && !this.func_151635_b(
                        aint,
                        aint1,
                    ...
                    if (k1 == BiomeGenBase.desert.biomeID) {
                        ...
                        if (l1 != BiomeGenBase.desert.biomeID && i2 != BiomeGenBase.desert.biomeID
                            && j2 != BiomeGenBase.desert.biomeID
                            && k2 != BiomeGenBase.desert.biomeID
                            && l1 != BiomeGenBase.coldTaiga.biomeID
                            && i2 != BiomeGenBase.coldTaiga.biomeID
                            && j2 != BiomeGenBase.coldTaiga.biomeID
                            && k2 != BiomeGenBase.coldTaiga.biomeID
                            ...
                            if (l1 != BiomeGenBase.jungle.biomeID && k2 != BiomeGenBase.jungle.biomeID
                                ...
                                && j2 != BiomeGenBase.jungle.biomeID) {
                                aint1[j1 + i1 * par3] = k1;
                            } else {
    ...
    private boolean func_151636_a(int[] p_151636_1_, int[] p_151636_2_, int p_151636_3_, int p_151636_4_,
        ...
        if (!compareBiomesById(p_151636_6_, p_151636_7_)) {
            ...
            if (this.func_151634_b(k1, p_151636_7_) && this.func_151634_b(l1, p_151636_7_)
                && this.func_151634_b(i2, p_151636_7_)
                && this.func_151634_b(j2, p_151636_7_)) {
    ...
    private boolean func_151635_b(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_,
        ...
        if (p_151635_6_ != p_151635_7_) {
            ...
            if (compareBiomesById(k1, p_151635_7_) && compareBiomesById(l1, p_151635_7_)
                && compareBiomesById(i2, p_151635_7_)
                && compareBiomesById(j2, p_151635_7_)) {
    ...
    private boolean func_151634_b(int p_151634_1_, int p_151634_2_) {
        if (compareBiomesById(p_151634_1_, p_151634_2_)) {
            ...
            BiomeGenBase.TempCategory tempcategory = BiomeGenBase.getBiome(p_151634_1_)
                .getTempCategory();
            BiomeGenBase.TempCategory tempcategory1 = BiomeGenBase.getBiome(p_151634_2_)
                .getTempCategory();
