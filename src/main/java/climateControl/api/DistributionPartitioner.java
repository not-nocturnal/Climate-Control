...
public abstract class DistributionPartitioner {
    ...
    // um, wow...
    private WeakHashMap<BiomeRandomizer.PickByClimate, HashMap<IncidenceModifier, BiomeRandomizer.PickByClimate>> calculatedClimates = new WeakHashMap<BiomeRandomizer.PickByClimate, HashMap<IncidenceModifier, BiomeRandomizer.PickByClimate>>();
    ...
    public BiomeRandomizer.PickByClimate partitioned(BiomeRandomizer.PickByClimate global, int x, int z) {
        ...
        HashMap<IncidenceModifier, BiomeRandomizer.PickByClimate> grouping = calculatedClimates.get(global);
