...
abstract public class BiomeSettings extends Settings {
    ...
    public class ID {
        ...
        public boolean active() {
            ...
            if (oldID != biomeID.value()) {
                String text = " Attempted to use biome " + this.name
                    + " at ID + "
                    + biomeID.value()
                    + " but that biome is assigned to "
                    + oldID;
        ...
        public ClimateDistribution configDistribution() {
            if (this.climate.value()
                .equalsIgnoreCase("DEFAULT")) return defaultDistribution();
            if (this.climate.value()
                .equalsIgnoreCase("")) return defaultDistribution();
            for (ClimateDistribution testedDistribution : ClimateDistribution.list) {
                if (this.climate.value()
                    .equalsIgnoreCase(testedDistribution.name())) {
    ...
    public void nameDefaultClimates() {
        for (ID element : this.ids) {
            if (element.climate.value()
                .equalsIgnoreCase("DEFAULT")) {
                int biomeID = element.biomeID()
                    .value();
