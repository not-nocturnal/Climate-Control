...
public class ClimateControlSettings extends Settings {
    ...
    private final Category climateZoneCategory = category(
    ...
    public final Mutable<Boolean> halfSize = climateZoneCategory
        .booleanSetting(halfSizeName, true, "half the climate zone size from vanilla, unless quartering");

    public final Mutable<Boolean> quarterSize = climateZoneCategory
        .booleanSetting(quarterSizeName, false, "quarter the climate zone size from vanilla");

    public final Mutable<Boolean> randomBiomes = climateZoneCategory
        .booleanSetting(randomBiomesName, false, "ignore climate zones altogether");
    ...
    public final Mutable<Integer> bandedClimateOffset = climateZoneCategory.intSetting(
        bandedClimateOffsetName,
        0,
    ...
    public final Mutable<Integer> xSpawnOffset = climateZoneCategory
        .intSetting(xSpawnOffsetName, 0, "X offset for initial spawn search in blocks");

    public final Mutable<Integer> zSpawnOffset = climateZoneCategory
        .intSetting(zSpawnOffsetName, 0, "Z offset for initial spawn search in blocks");
    ...
    public final Mutable<Boolean> allowDerpyIslands = climateControlCategory
        .booleanSetting(allowDerpyIslandsName, false, "place little islands near shore rather than in deep ocean");
    ...
    public final Mutable<Boolean> testingMode = climateControlCategory
        .booleanSetting("TestingMode", false, "add testing routines and crash in suspicious circumstances");
    ...
    public final Mutable<Integer> biomeSize = climateControlCategory
        .intSetting(biomeSizeName, 4, "Biome size, exponential: 4 is regular and 6 is large biomes");
    ...
    public final Mutable<Boolean> vanillaLandAndClimate = climateControlCategory
        .booleanSetting(vanillaStructure, false, "Generate land masses and climate zones similar to vanilla 1.7");

    public final Mutable<Boolean> oneSixCompatibility = climateControlCategory
        .booleanSetting(oneSixCompatibilityName, false, "Use 1.6 compatibility mode");

    public final Mutable<Integer> climateRingsNotSaved = climateControlCategory
        .intSetting("climateRingsNotSaved", 3, "climate not saved on edges; -1 deactivates saving climates");
    ...
    public final Mutable<Integer> subBiomeRingsNotSaved = climateControlCategory.intSetting(
        "subBiomeRingsNotSaved",
        -1,
        "subbiomes not saved on edges, default 3, -1 deactivates saving sub-biomes");

    public final Mutable<Integer> mushroomIslandIncidence = climateControlCategory
        .intSetting(mushroomIslandIncidenceName, 10, "per thousand; vanilla is 10");

    public final Mutable<Integer> percentageRiverReduction = climateControlCategory.intSetting(
        percentageRiverReductionName,
        0,
        "Percentage of rivers prevented; changes cause chunk boundaries at some rivers");

    public final Mutable<Boolean> widerRivers = climateControlCategory
        .booleanSetting(widerRiversName, "True for triple-width rivers", false);

    public final Mutable<Boolean> wideBeaches = climateControlCategory
        .booleanSetting(wideBeachesName, "True for double-width beaches", false);

    public final Mutable<Boolean> controlVillageBiomes = climateControlCategory.booleanSetting(
        controlVillageBiomesName,
    ...
    private final Category climateIncidenceCategory = category(
        "Climate Incidences",
    ...
    public final Mutable<Integer> hotIncidence = climateIncidenceCategory
        .intSetting(hotIncidenceName, 2, "relative incidence of hot zones like savanna/desert/plains/mesa");
    public final Mutable<Integer> warmIncidence = climateIncidenceCategory
        .intSetting(warmIncidenceName, 1, "relative incidence of warm zones like forest/plains/hills/jungle/swamp");
    public final Mutable<Integer> coolIncidence = climateIncidenceCategory.intSetting(
        coolIncidenceName,
        1,
        "relative incidence of cool zones like forest/plains/hills/taiga/roofed forest");
    public final Mutable<Integer> snowyIncidence = climateIncidenceCategory
        .intSetting(snowyIncidenceName, 2, "relative incidence of snowy zones");

    private final Category oceanControlCategory = category(
    ...
    public final Mutable<Boolean> vanillaBiomesOn = climateControlCategory
        .booleanSetting(vanillaBiomesOnName, "Include vanilla biomes in world", true);
    ...
    public final Mutable<Boolean> interveneInHighlandsWorlds = climateControlCategory
    ...
    public final Mutable<Boolean> suppressInStandardWorlds = climateControlCategory.booleanSetting(
        suppressInStandardWorldsName,
        false,
        "suppress Climate Control generation in default, large biomes, and amplified worlds");

    public final Mutable<Boolean> forceStartContinent = climateControlCategory
